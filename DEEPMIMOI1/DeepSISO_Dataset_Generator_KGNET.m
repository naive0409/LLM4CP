...
% dataset_params_UP = read_params('parameters_KGNETUPSISO.m');
% dataset_params_UP = read_params('parameters_KGNETDownSISO.m');
dataset_params_UP = read_params('patameterup241216.m');
[DeepSISO_dataset_up, dataset_params_UP] = DeepMIMO_generator(dataset_params_UP);
size(DeepSISO_dataset_up{1}.user{1}.channel)
% -------------------------- Output Examples -----------------------------%
