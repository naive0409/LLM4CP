...
class Dataset_Pro(data.Dataset):
    def __init__(self, file_path_r, file_path_t, is_train=1, ir=1, SNR=15, is_U2D=0, is_few=0,
        ...
        if use_deepmimo_data:
            ...
            H_his = rearrange(H_his, 'a b (d e) -> d a (b e)', e=32)  # 145600/32=4550 , 16, 48*32=1536
            H_pre = rearrange(H_pre, 'a b (d e) -> d a (b e)', e=32)
        ...
        if is_few == 1:
            H_pre = H_pre[::10, ...]
            H_his = H_his[::10, ...]
        self.pred = H_pre  # b,4,(48*2)
        self.prev = H_his  # b,16,(48*2)
